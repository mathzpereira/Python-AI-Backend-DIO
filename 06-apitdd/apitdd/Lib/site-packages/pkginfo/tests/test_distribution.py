...
def test_distribution_ctor_defaults():
    ...
    assert sdist.metadata_version is None
    # version 1.0
    assert sdist.name is None
    assert sdist.version is None
    assert sdist.platforms == ()
    assert sdist.supported_platforms == ()
    assert sdist.summary is None
    assert sdist.description is None
    assert sdist.keywords is None
    assert sdist.home_page is None
    assert sdist.download_url is None
    assert sdist.author is None
    assert sdist.author_email is None
    assert sdist.license is None
    # version 1.1
    ...
    # version 1.2
    assert sdist.maintainer is None
    assert sdist.maintainer_email is None
    assert sdist.requires_python is None
    ...
    assert sdist.description_content_type is None
    # version 2.2
